...
function CatalogueContent() {
  ...
  const waMsg = (saree: Saree) =>
    `https://wa.me/919025186639?text=${encodeURIComponent(`Hi! I'm interested in the *${saree.name}* (${saree.category}) priced at ₹${saree.price.toLocaleString()}. Could you share more details?`)}`;
    ...
    <div className="min-h-screen" style={{ background: "var(--cream)" }}>
      ...
      <footer className="bg-[var(--maroon)] text-white/80 py-8 px-8 mt-12">
        <div className="max-w-7xl mx-auto text-center text-sm">
          <p>Vastra Bhoomi Collections · No. 12, Main Street, Chennai · +91 9025186639</p>
        </div>
      </footer>
    </div>
  );
