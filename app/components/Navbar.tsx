      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-[rgba(200,146,42,0.15)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-3">
            <Image src="/Gemini_Generated_Image_5z5qnd5z5qnd5z5q.png" alt="Vastra Bhoomi" width={44} height={44} className="rounded-full" />
            <div>
              <div className="font-display font-semibold text-lg leading-tight" style={{ color: "#6B1A2A" }}>Vastra Bhoomi</div>
              <div className="text-[9px] tracking-[0.2em] uppercase" style={{ color: "#C8922A" }}>Collections</div>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a href="https://wa.me/919025186639" target="_blank" rel="noopener noreferrer" className="nav-link" style={{ color: "#25D366" }}>
              WhatsApp
            </a>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-[rgba(200,146,42,0.1)] px-6 py-5 flex flex-col gap-4">
            ...
            <a href="https://wa.me/919025186639" target="_blank" rel="noopener noreferrer" className="nav-link" style={{ color: "#25D366" }}>WhatsApp</a>
