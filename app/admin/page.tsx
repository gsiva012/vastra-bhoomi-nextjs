  ...
  if (!session) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ background: "var(--cream)" }}>
        <Image src="/Gemini_Generated_Image_5z5qnd5z5qnd5z5q.png" alt="Logo" width={80} height={80} className="rounded-full mb-4" />
        <h1 className="font-display text-4xl font-semibold mb-1" style={{ color: "#6B1A2A" }}>Vastra Bhoomi</h1>
    ...
    <div className="min-h-screen" style={{ background: "var(--cream)" }}>
      ...
      <nav className="sticky top-0 z-50 px-8 py-4 flex items-center justify-between" style={{ background: "#6B1A2A" }}>
        <div className="flex items-center gap-3">
          <Image src="/Gemini_Generated_Image_5z5qnd5z5qnd5z5q.png" alt="Logo" width={36} height={36} className="rounded-full opacity-90" />
          <div>
            <div className="font-display text-white font-semibold">Vastra Bhoomi Admin</div>
