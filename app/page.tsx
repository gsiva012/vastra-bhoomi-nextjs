...
export default function Home() {
  const pureKanchi = [
    { id: 1, name: "Bridal Crimson", image: "/ChatGPT_Image_May_23__2026__10_17_08_AM.png", tagline: "Strength in every fold. Grace in every glance.", price: "₹18,500" },
    { id: 2, name: "Emerald Temple", image: "/ChatGPT_Image_May_23__2026__10_19_11_AM.png", tagline: "Prosperity in every prayer.", price: "₹16,800" },
    { id: 7, name: "Magenta Korvai", image: "/ChatGPT_Image_May_23__2026__10_20_40_AM.png", tagline: "Vibrance in every weave.", price: "₹19,500" },
    { id: 11, name: "Violet Brocade", image: "/ChatGPT_Image_May_23__2026__10_43_15_AM.png", tagline: "Tradition in every thread.", price: "₹21,000" },
  ];
  const semiKanchi = [
    { id: 5, name: "Silver Zari", image: "/ChatGPT_Image_May_23__2026__10_11_13_AM.png", tagline: "Purity in every drape.", price: "₹9,800" },
    { id: 6, name: "Dual Tone Brown", image: "/ChatGPT_Image_May_23__2026__10_12_55_AM.png", tagline: "Balance in every hue.", price: "₹11,200" },
    { id: 9, name: "Mustard Checks", image: "/ChatGPT_Image_May_23__2026__10_37_45_AM_1_.png", tagline: "Rooted in culture.", price: "₹12,500" },
    { id: 10, name: "Rose Pink", image: "/ChatGPT_Image_May_23__2026__10_39_22_AM.png", tagline: "Cultivated in culture.", price: "₹10,800" },
  ];
    ...
    <div className="min-h-screen" style={{ background: "var(--cream)" }}>
      ...
      <section className="relative overflow-hidden">
        <div className="hero-shimmer relative">
          <Image src="/banner-1.png" alt="Vastra Bhoomi Premium Saree Collection" width={1440} height={600} className="w-full object-cover" priority />
        </div>
      </section>
      ...
      <footer className="bg-[var(--maroon)] text-white/80 py-10 px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <Image src="/Gemini_Generated_Image_5z5qnd5z5qnd5z5q.png" alt="Logo" width={40} height={40} className="rounded-full opacity-90" />
            <div>
              <div className="font-display text-white text-lg">Vastra Bhoomi Collections</div>
              <div className="text-[10px] tracking-widest text-[var(--gold-light)]">PURE KANCHI SILK</div>
            </div>
          </div>
          <div className="text-center text-sm">
            <p>No. 12, Main Street, Chennai</p>
            <p>+91 9025186639 · www.vastrabhoomi.com</p>
          </div>
          <div className="text-[10px] text-white/40">© 2026 Vastra Bhoomi</div>
        </div>
      </footer>
    </div>
  );
